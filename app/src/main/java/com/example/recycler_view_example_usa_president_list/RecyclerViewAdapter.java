...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.tv_president_name.setText(mData.get(holder.getAdapterPosition()).getName());
        holder.img_president_thumbnail.setImageResource(mData.get(holder.getAdapterPosition()).getThumbnail());
